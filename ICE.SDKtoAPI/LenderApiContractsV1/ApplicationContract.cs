...
namespace ICE.SDKtoAPI.LenderApiContractsV1
{
	...
	public class ApplicationContract
	{
		...
		[DataMember(Name="applicationIndex")]
		...
		public List<ApplicationContractAssets> Assets { get; set; }
		...
		[DataMember(Name="aTRQMBorrowers")]
		...
		public ApplicationContractBorrower Borrower { get; set; }
		...
		public ApplicationContractCoborrower Coborrower { get; set; }
		...
		public List<ApplicationContractEmployment> Employment { get; set; }
		...
		public List<ApplicationContractLiabilities> Liabilities { get; set; }
		...
		public List<ApplicationContractResidences> Residences { get; set; }

		[DataMember(Name="respa6")]
		public string Respa6 { get; set; }

		[DataMember(Name="selfEmployedIncomes")]
		...
		public List<LoanContractTax4506> Tax4506s { get; set; }
