...
namespace ICE.SDKtoAPI.LenderApiContractsV3
{
    ...
    public class UsdaContract
    {
        ...
        [DataMember(Name = "borrowerBaseIncome")]
        ...
        public string CertificationEffectiveDate { get; set; }
        ...
        [DataMember(Name = "coborrowerBaseIncome")]
        public decimal? CoborrowerBaseIncome { get; set; }

        [DataMember(Name = "confirmedObligationProcessedDate")]
        public string ConfirmedObligationProcessedDate { get; set; }

        [DataMember(Name = "loanNoteGuaranteeIssuedDate")]
        public string LoanNoteGuaranteeIssuedDate { get; set; }

        [DataMember(Name = "loanNoteGuaranteeRequestReceivedDate")]
        public string LoanNoteGuaranteeRequestReceivedDate { get; set; }

        [DataMember(Name = "obligationInGlsDate")]
        public string ObligationInGlsDate { get; set; }

        [DataMember(Name = "verifiedInUnifiDate")]
        public string VerifiedInUnifiDate { get; set; }
        ...
        public string GuaranteePeriodBeginsDate { get; set; }

        [DataMember(Name = "guaranteePeriodEndsDate")]
        public string GuaranteePeriodEndsDate { get; set; }
        ...
        [DataMember(Name = "previousLandlordZip")]
        public string PreviousLandlordZip { get; set; }
        ...
        public string UnderwritingDecisionDate { get; set; }
        ...
        public List<UsdaHouseholdIncomeContract> UsdaHouseholdIncomes { get; set; }
