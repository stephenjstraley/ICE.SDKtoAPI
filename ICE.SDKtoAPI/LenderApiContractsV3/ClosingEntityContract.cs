...
{
    [DataContract]
    public class ClosingEntityContract
    {
        ...
        public string RecordableDocumentTrustDate { get; set; }
        ...
        [DataMember(Name = "nonBorrowingOwner")]
        public string NonBorrowingOwner { get; set; }
