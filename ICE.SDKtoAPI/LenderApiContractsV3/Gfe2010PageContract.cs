...
{
    [DataContract]
    public class Gfe2010PageContract
    {
        ...
        public string FirstArmChangeDate { get; set; }

        [DataMember(Name = "gfe2010FwbcFwscs")]
        public List<Gfe2010FwbcFwscContract> Gfe2010FwbcFwscs { get; set; }

        [DataMember(Name = "gfe2010GfeCharges")]
        public List<Gfe2010GfeChargeContract> Gfe2010GfeCharges { get; set; }
