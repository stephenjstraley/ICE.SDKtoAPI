...
{
    [DataContract]
    public class LoanProductDataContract
    {
        ...
        public List<BuydownContract> Buydowns { get; set; }
        ...
        public List<HelocRepaymentDrawPeriodContract> HelocRepaymentDrawPeriods { get; set; }
        ...
        public string BorrowerEstimatedClosingDate { get; set; }
        ...
        [DataMember(Name = "minimumDrawPeriodPaymentPercent")]
        public decimal? MinimumDrawPeriodPaymentPercent { get; set; }
        ...
        public List<PrepaymentPenaltyContract> PrepaymentPenalties { get; set; }
        ...
        public string ScheduledFirstPaymentAdjustmentDate { get; set; }
        ...
        [DataMember(Name = "helocPaymentBasisType")]
        public string HelocPaymentBasisType { get; set; }
        ...
        [DataMember(Name = "helocInitialPaymentBasisType")]
        public string HelocInitialPaymentBasisType { get; set; }
        ...
        [DataMember(Name = "helocDailyPeriodicRate")]
        public decimal? HelocDailyPeriodicRate { get; set; }

        [DataMember(Name = "helocMonthlyPeriodicRate")]
        public decimal? HelocMonthlyPeriodicRate { get; set; }

        [DataMember(Name = "helocPeriodicRateIndicator")]
        public string HelocPeriodicRateIndicator { get; set; }

        [DataMember(Name = "helocMinimumInitialAdvanceRequiredIndicator")]
        public bool? HelocMinimumInitialAdvanceRequiredIndicator { get; set; }

        [DataMember(Name = "helocMinimumInitialAdvancePercent")]
        public decimal? HelocMinimumInitialAdvancePercent { get; set; }

        [DataMember(Name = "helocMinimumSubsequentAdvanceAmount")]
        public decimal? HelocMinimumSubsequentAdvanceAmount { get; set; }

        [DataMember(Name = "helocMinimumSubsequentAdvancePercent")]
        public decimal? HelocMinimumSubsequentAdvancePercent { get; set; }

        [DataMember(Name = "helocEscrowAccountIndicator")]
        public bool? HelocEscrowAccountIndicator { get; set; }

        [DataMember(Name = "helocInstallmentLoanOptionIndicator")]
        public bool? HelocInstallmentLoanOptionIndicator { get; set; }
        ...
        [DataMember(Name = "helocDrawFractionBalancedividend")]
        public int? HelocDrawFractionBalancedividend { get; set; }

        [DataMember(Name = "helocDrawFractionBalancedivisor")]
        public int? HelocDrawFractionBalancedivisor { get; set; }

        [DataMember(Name = "helocDrawExtensionMonths")]
        public int? HelocDrawExtensionMonths { get; set; }

        [DataMember(Name = "helocRepaymentBasis")]
        public bool? HelocRepaymentBasis { get; set; }

        [DataMember(Name = "helocRepaymentBasisType")]
        public string HelocRepaymentBasisType { get; set; }

        [DataMember(Name = "helocRepaymentInterestOnlyIndicator")]
        public bool? HelocRepaymentInterestOnlyIndicator { get; set; }

        [DataMember(Name = "helocRepaymentFractionBalancedividend")]
        public int? HelocRepaymentFractionBalancedividend { get; set; }

        [DataMember(Name = "helocRepaymentFractionBalancedivisor")]
        public int? HelocRepaymentFractionBalancedivisor { get; set; }

        [DataMember(Name = "helocRepaymentMinPayment")]
        public decimal? HelocRepaymentMinPayment { get; set; }

        [DataMember(Name = "helocMinInstallmentLoanAmount")]
        public decimal? HelocMinInstallmentLoanAmount { get; set; }

        [DataMember(Name = "helocMaxOpenInstallmentLoans")]
        public int? HelocMaxOpenInstallmentLoans { get; set; }

        [DataMember(Name = "helocInstallmentLoanTermYearFrom")]
        public int? HelocInstallmentLoanTermYearFrom { get; set; }

        [DataMember(Name = "helocInstallmentLoanTermYearTo")]
        public int? HelocInstallmentLoanTermYearTo { get; set; }

        [DataMember(Name = "helocInstallmentLoanFinanceCharge")]
        public decimal? HelocInstallmentLoanFinanceCharge { get; set; }

        [DataMember(Name = "helocInstallmentLoanMargin")]
        public decimal? HelocInstallmentLoanMargin { get; set; }

        [DataMember(Name = "helocInstallmentLoanMaxApr")]
        public decimal? HelocInstallmentLoanMaxApr { get; set; }

        [DataMember(Name = "helocInstallmentLoanMinApr")]
        public decimal? HelocInstallmentLoanMinApr { get; set; }

        [DataMember(Name = "helocInstallmentLoanApr")]
        public decimal? HelocInstallmentLoanApr { get; set; }

        [DataMember(Name = "helocAutoDebitFeature")]
        public bool? HelocAutoDebitFeature { get; set; }

        [DataMember(Name = "helocAutoDebitDiscount")]
        public decimal? HelocAutoDebitDiscount { get; set; }

        [DataMember(Name = "helocPaperBillingFee")]
        public decimal? HelocPaperBillingFee { get; set; }

        [DataMember(Name = "helocPhotocopyFee")]
        public decimal? HelocPhotocopyFee { get; set; }

        [DataMember(Name = "helocResearchFee")]
        public decimal? HelocResearchFee { get; set; }

        [DataMember(Name = "helocRefundableFee")]
        public string HelocRefundableFee { get; set; }
        ...
        [DataMember(Name = "helocHistoricalTableDayIndex")]
        public int? HelocHistoricalTableDayIndex { get; set; }

        [DataMember(Name = "helocHistoricalTableMonthIndex")]
        public int? HelocHistoricalTableMonthIndex { get; set; }

        [DataMember(Name = "helocHistoricalTableDefaultMargin")]
        public decimal? HelocHistoricalTableDefaultMargin { get; set; }

        [DataMember(Name = "helocPropertyInsuranceIndicator")]
        public bool? HelocPropertyInsuranceIndicator { get; set; }

        [DataMember(Name = "helocCollectInterimInterestIndicator")]
        public bool? HelocCollectInterimInterestIndicator { get; set; }

        [DataMember(Name = "agreementAmmendsRestatesIndicator")]
        public bool? AgreementAmmendsRestatesIndicator { get; set; }
        ...
        [DataMember(Name = "lenderRepresentativeUserId")]
        public string LenderRepresentativeUserId { get; set; }

        [DataMember(Name = "lenderRepresentativeJobTitle")]
        public string LenderRepresentativeJobTitle { get; set; }

        [DataMember(Name = "lenderRepresentativeUserType")]
        public string LenderRepresentativeUserType { get; set; }

        [DataMember(Name = "helocHistoricalIndexYearSettings")]
        public List<HelocHistoricalIndexYearSettingContract> HelocHistoricalIndexYearSettings { get; set; }
